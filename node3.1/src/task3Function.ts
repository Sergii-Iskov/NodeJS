  ...
  for (const key in obj) {
    if (Object.prototype.hasOwnProperty.call(obj, key)) {
      ...
      if (typeof element === "undefined") {
        ...
        if (element) {
          if (typeof element.cvalue === "number") {
            result += element.cvalue;
          } else if (typeof element.cvalue === "string") {
            if (!Number.isNaN(+element.cvalue)) result += +element.cvalue;
            else result += 2022;
          } else if (typeof element.cvalue === "undefined") {
            result += 2022;
          } else {
            result += func1(element.cvalue);
          }
        }
      }
    }
...
console.log("result example = " + func1(example));
